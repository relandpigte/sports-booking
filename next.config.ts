    ...
    const securityHeaders = [
      ...
      },
      {
        ...
        value: [
          ...
          "connect-src 'self' https://*.googleapis.com https://www.google-analytics.com https://*.google-analytics.com https://www.facebook.com https://vitals.vercel-insights.com https://*.vercel-insights.com https://*.ably.io wss://*.ably.io https://*.ably-realtime.com wss://*.ably-realtime.com https://*.ably.net wss://*.ably.net",
