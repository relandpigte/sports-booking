  ...
  return (
    <div className="mx-auto max-w-3xl">
      <div className="mb-6">
        ...
        <p className="mt-2 text-sm leading-6 text-slate-500">Event discussions and private venue conversations appear only while your confirmed booking is active.</p>
      </div>
      {result.conversations.length > 0 ? (
        ...
        <div className="rounded-3xl border border-dashed border-slate-300 bg-white px-6 py-16 text-center">
          ...
          <h2 className="mt-5 text-xl font-bold text-navy">No active conversations</h2>
          <p className="mx-auto mt-2 max-w-md text-sm leading-6 text-slate-500">Confirmed court bookings create a private venue conversation. Confirmed event registrations add you to that event’s group discussion.</p>
