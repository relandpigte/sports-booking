          ...
          >
            ...
            <label className="relative block min-w-0">
              ...
              <select
                ...
                className="h-11 w-full appearance-none rounded-xl border border-gray-300 bg-white px-3 pr-10 text-sm font-semibold text-navy transition-colors hover:border-gray-400 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20"
              >
