...
export const MANUAL_SERVICE_FEE_RATE = 0.03;
...
// platform fee. Keep this separate from the automatic rate so each payment
// snapshots the policy selected when its checkout was created.
